...
/// WEATHER CENTER (PRO) Ã¢â‚¬â€ simple, readable, drill-down demo
/// Ã¢â‚¬Â¢ Shows Region summary, KPI chips, and State Ã¢â€ â€™ County drill-down
/// Ã¢â‚¬Â¢ Uses local demo data so you can see layout immediately
/// Ã¢â‚¬Â¢ Keep the class name exactly as-is (WeatherCenterPro) Ã¢â‚¬â€ main.dart depends on it
...
class _WeatherCenterProState extends State<WeatherCenterPro> {
  ...
  Widget _countyTile(Map<String, dynamic> r) {
    final county = (r['county'] ?? 'Ã¢â‚¬â€').toString();
  ...
  Widget _badge(String text) {
    final t = text.isEmpty ? 'Ã¢â‚¬â€' : text;
    return Container(
